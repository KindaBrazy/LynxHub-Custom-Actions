...
function Database_Icon$1(props) {
...
function topToast(options) {
  ...
  addToast({
    ...
    endContent: placement.includes("bottom") && color === "danger" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full flex flex-row justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$6, { size: "sm", color: "warning", variant: "light", children: "Restart App" }) }) : null
  });
}
...
const {compact} = await importShared('lodash');
...
function AddToCategories() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Checkbox,
      {
        id: "pinned",
...
const {Button: Button$5,Input: Input$2,Textarea} = await importShared('@heroui/react');

const {ColorPicker} = await importShared('antd');
...
function CardDetails() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input$2, { onValueChange: onTitleChange, value: editingCard?.title || "", placeholder: "Card Title (required)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Textarea,
        {
          maxRows: 3,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "accent-color", className: "text-sm text-foreground-500", children: "Accent Color:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ColorPicker,
          {
            size: "large",
...
const {Select,SelectItem} = await importShared('@heroui/react');
...
function CardType() {
  ...
  const onSelectionChange = (selected) => {
    if (selected !== "all") {
      const value = Array.from(selected)[0].toString();
      value.toString();
      dispatch(reducerActions.setCardType(value));
    }
  };
  const startContent = useMemo$4(() => {
    switch (cardType) {
      case "executable":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Play_Icon, {});
      case "browser":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Web_Icon, {});
      case "terminal":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Terminal_Icon, {});
      case "terminal_browser":
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Terminal_Icon, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Web_Icon, {})
        ] });
    }
  }, [cardType]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground-600", children: "Select the card type that fits your needs:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Select,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { startContent: /* @__PURE__ */ jsxRuntimeExports.jsx(Play_Icon, {}), description: "Run and manage a program", children: "Executable" }, "executable"),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectItem,
            {
              startContent: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Terminal_Icon, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Web_Icon, {})
              ] }),
              description: "Open a terminal and a browser simultaneously.",
              children: "Terminal & Browser"
            },
            "terminal_browser"
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { startContent: /* @__PURE__ */ jsxRuntimeExports.jsx(Web_Icon, {}), description: "Open a browser with a custom URL.", children: "Browser" }, "browser"),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectItem,
            {
              startContent: /* @__PURE__ */ jsxRuntimeExports.jsx(Terminal_Icon, {}),
...
function AddExe() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Button$4, { onPress: handleAdd, isLoading, startContent: !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(PlayDuo_Icon, {}), fullWidth: true, children: "Add Executable" });
}
    ...
    switch (item.type) {
      ...
      case "script":
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-full text-small ml-1.5 truncate", children: item.action }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      (cardType === "terminal_browser" || cardType === "terminal") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-x-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button$2, { variant: "flat", onPress: handleAddCommand, startContent: /* @__PURE__ */ jsxRuntimeExports.jsx(Add_Icon, {}), children: "Add" })
      ] }),
...
function FormSection({ title, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-foreground-400", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 rounded-2xl shadow-small  bg-white dark:bg-LynxRaisinBlack p-4", children })
      ]
    }
  );
}

const {Card: Card$2} = await importShared('@heroui/react');
...
function NewCard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { transition: { duration: 0.2 }, whileHover: { y: -5, scale: 1.05 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card$2,
    {
      className: "w-[170px] h-[150px] group flex flex-col items-center justify-center p-4 gap-y-4 border-2 border-dashed border-gray-600 hover:border-secondary",
      onPress: handleCreateNew,
      isPressable: true,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex size-12 items-center justify-center rounded-full bg-foreground-300 dark:bg-foreground-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Add_Icon, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground-500 group-hover:text-foreground transition-colors duration-300", children: "Create New" })
      ]
    }
  ) });
}
...
function PreviewCard({ card, handleEdit, icon }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { transition: { duration: 0.2 }, whileHover: { y: -5, scale: 1.05 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card$1,
    {
      className: "text-center p-8 bg-foreground-100 w-[170px] h-[150px] flex flex-col items-center justify-center gap-y-4 shadow-lg group",
...
const {Button,Modal,ModalBody,ModalContent,ModalFooter,ModalHeader} = await importShared('@heroui/react');

const {useMemo} = await importShared('react');

const {useDispatch: useDispatch$2} = await importShared('react-redux');
function CustomActionsModal({ show, isOpen, tabID }) {
  ...
  const onOpenChange = (value) => {
    if (!value) {
      dispatch(reducerActions.closeModal({ tabID }));
      setTimeout(() => {
        dispatch(reducerActions.removeModal({ tabID }));
      }, 500);
    }
  };
  const saveCard = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModalContent, { children: (onClose) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalHeader, { className: "justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: view === "form" && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "light", onPress: handleBackToList, isIconOnly: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDuo_Icon, { className: "size-5" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center gap-2 justify-center", children: formTitle }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBody, { as: LynxScroll, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomActionsManager, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ModalFooter, { className: "justify-between", children: view === "form" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { color: "danger", variant: "light", onPress: deleteCard, startContent: /* @__PURE__ */ jsxRuntimeExports.jsx(TrashDuo_Icon, {}), children: "Delete" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center gap-x-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                startContent: /* @__PURE__ */ jsxRuntimeExports.jsx(DiskDuo_Icon, {}),
                children: "Save Card"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { color: "warning", variant: "light", onPress: handleBackToList, children: "Cancel" })
          ] })
