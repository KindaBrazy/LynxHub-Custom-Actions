...
const {useId: useId$2,useRef: useRef$4,useContext: useContext$7,useInsertionEffect: useInsertionEffect$1} = await importShared('react');
...
const {useContext: useContext$6,useId,useEffect: useEffect$1,useCallback: useCallback$2} = await importShared('react');
...
function useIsPresent() {
    return isPresent(useContext$6(PresenceContext));
}
...
const {useMemo: useMemo$5,useRef: useRef$3,useState: useState$1,useContext: useContext$5} = await importShared('react');
...
const {useContext: useContext$4,useRef: useRef$1,useMemo: useMemo$4} = await importShared('react');

const shouldInheritGroup = (inherit) => inherit === true;
const shouldInheritId = (inherit) => shouldInheritGroup(inherit === true) || inherit === "id";
const LayoutGroup = ({ children, id, inherit = true }) => {
    const layoutGroupContext = useContext$4(LayoutGroupContext);
    const deprecatedLayoutGroupContext = useContext$4(DeprecatedLayoutGroupContext);
...
export { AnimatePresence as A, DeprecatedLayoutGroupContext as D, LayoutGroup as L, MotionConfigContext as M, PresenceContext as P, SwitchLayoutGroupContext as S, useIsomorphicLayoutEffect as a, useForceUpdate as b, makeUseVisualState as c, MotionContext as d, PopChild as e, PresenceChild as f, filterProps as g, useComposedRefs as h, useIsPresent as i, jsxRuntimeExports as j, usePresence as k, isValidMotionProp as l, motionComponentSymbol as m, LayoutGroupContext as n, loadFeatures as o, LazyContext as p, loadExternalIsValidProp as q, resolveMotionValue as r, createMotionProxy as s, isRefObject as t, useConstant as u };
